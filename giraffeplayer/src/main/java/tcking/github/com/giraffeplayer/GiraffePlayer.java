...
//            } else
    ...
    private void updatePausePlay() {
        if (videoView.isPlaying()) {
            $.id(R.id.app_video_play).image(R.drawable.rjc_click_pause_selector);
        } else {
            $.id(R.id.app_video_play).image(R.drawable.rjc_click_play_selector);
        }
    }
...
//                $.id(R.id.app_video_fullscreen).visible();
    ...
    public GiraffePlayer(final Activity activity,View view) {
        try {
