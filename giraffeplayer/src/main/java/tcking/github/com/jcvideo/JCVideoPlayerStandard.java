...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public boolean setUp(String url, int screen, Object... objects) {
        ...
        if (super.setUp(url, screen, objects)) {
            ...
            if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
                ...
                fullscreenButton.setImageResource(R.drawable.rjc_enlarge);
    ...
    public void setAllControlsVisible(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        app_video_status_text.setVisibility(thumbImg);
        coverImageView.setVisibility(coverImg);
        bottomProgressBar.setVisibility(bottomPro);
    }
    public void setbt1Visible(int startBtn){
        startButton1.setVisibility(startBtn);
    }

    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            startButton.setImageResource(R.drawable.rjc_click_pause_selector);
            startButton1.setImageResource(R.drawable.rjc_click_pause_selector);
        } else if (currentState == CURRENT_STATE_ERROR) {
            startButton.setImageResource(R.drawable.rjc_click_error_selector);
            startButton1.setImageResource(R.drawable.rjc_click_error_selector);
        } else {
            startButton.setImageResource(R.drawable.jc_click_play_selector);
            startButton1.setImageResource(R.drawable.dianbo_play1);
        }
    }
...
//            localLayoutParams.y = getContext().getResources().getDimensionPixelOffset(R.dimen.jc_volume_dialog_margin_left);
    ...
    public void startDismissControlViewTimer() {
        ...
        DISSMISS_CONTROL_VIEW_TIMER.schedule(mDismissControlViewTimerTask, 10);
    }
...
//                            startButton1.setVisibility(View.INVISIBLE);
