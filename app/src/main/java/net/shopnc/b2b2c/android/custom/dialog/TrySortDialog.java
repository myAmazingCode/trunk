...
public class TrySortDialog {
    ...
    public void initPopupWindowView() {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_trygood_sort, null);
...
//        popupWindow.setAnimationStyle(R.style.AnimationFade);
        ...
        adapter = new RRecyclerAdapter<TrySortBean>(context, R.layout.dialog_trygood_sort_recyclerview_item) {
            @Override
