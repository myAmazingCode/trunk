...
public class PickerView extends View
{
    ...
    private void drawLines(Canvas canvas){
        ...
        canvas.drawLine(0,mViewHeight/3+2,mViewWidth,mViewHeight/3+2,linePaint);
        canvas.drawLine(0,mViewHeight/3*2+2,mViewWidth,mViewHeight/3*2+2,linePaint);
