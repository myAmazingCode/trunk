...
public class SystemHelper {
    ...
    public static void createShortcut(Context context, Class<?> clazz) {
        ...
        //快捷方式的图标
        ShortcutIconResource iconResource = ShortcutIconResource.fromContext(context, R.drawable.ic_launcher);
...
//                .cacheInMemory(true)                        // 设置下载的图片是否缓存在内存中
    ...
    /**
     * DisplayImageOptions是用于设置图片显示的类-圆角显示
     *
     * @param cornerRadiusPixels 圆角度数
     */
    public static DisplayImageOptions getRoundedBitmapDisplayImageOptions(int cornerRadiusPixels) {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                ...
                .bitmapConfig(Bitmap.Config.RGB_565)
                .considerExifParams(true)
                .displayer(new FadeInBitmapDisplayer(0))//图片显示时间
                .displayer(new RoundedBitmapDisplayer(cornerRadiusPixels))//圆角
                .build();
