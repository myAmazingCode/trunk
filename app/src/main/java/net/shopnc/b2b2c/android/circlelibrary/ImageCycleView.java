package net.shopnc.b2b2c.android.circlelibrary;
...
public class ImageCycleView extends LinearLayout {
     ...
     * 图片轮播视图
     */
    private NoScrollViewPager mAdvPager = null;
    /**
     * 滚动图片视图适配
     */
    ...
    private boolean isCyclr = true;   //是否自动轮播
    private ArrayList<String> imageList = new ArrayList<String>();   //用于判断是否与切换效果
    ...
    private void init(Context context) {
        ...
        imageName = findViewById(R.id.viewGroup2);
    }
     ...
     * @param pointer
     */
    public void setImageResources(ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener, boolean flag, boolean pointer) {
        setImageResources(imageUrlList, imageCycleViewListener, flag);
        if (pointer) {
     ...
     * @param flag                   是否自动轮播
     */
    public void setImageResources(ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener, boolean flag) {
        isCyclr = flag;
        ...
        if (imageList.size() == 1) {
            mAdvPager.setNoScroll(true);
        } else {
            mAdvPager.setNoScroll(false);
        }
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            int imageParams = (int) (mScale * 10 - 10f);// XP与DP转换，适应应不同分辨率
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(R.drawable.nc_page_circle_on);
            } else {
                mImageViews[i].setBackgroundResource(R.drawable.nc_page_circle_off);
            }
     ...
     * @param imageCycleViewListener
     */
    public void setImageResources(ArrayList<String> imageDesList, ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener, boolean flag) {
        isCyclr = flag;
        imageList = imageUrlList;
        mGroup.setVisibility(View.VISIBLE);
        ...
        imageName.setTextColor(getResources().getColor(R.color.nc_text_blue));
    ...
    private final class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageViews[index].setBackgroundResource(R.drawable.nc_page_circle_on);
        }
    }
