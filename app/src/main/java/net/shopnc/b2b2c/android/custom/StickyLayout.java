...
public class StickyLayout extends LinearLayout implements NestedScrollingParent {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        params.height = getMeasuredHeight() - bottomView.getMeasuredHeight();
        setMeasuredDimension(getMeasuredWidth(), topView.getMeasuredHeight() + bottomView.getMeasuredHeight());
    }
