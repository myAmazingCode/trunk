...
import net.shopnc.b2b2c.android.xrefresh.listener.OnBottomLoadMoreTime;
import net.shopnc.b2b2c.android.xrefresh.listener.OnTopRefreshTime;
import net.shopnc.b2b2c.android.xrefresh.recyclerview.BaseRecyclerAdapter;
import net.shopnc.b2b2c.android.xrefresh.recyclerview.XSpanSizeLookup;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime,
    ...
    public boolean isRecyclerView() {
        if (mSlienceLoadMore) {
            return false;
        } else return null != child && child instanceof RecyclerView;
    }
