 ...
 *
 * @author lzz
 *         Created 2017/5/2 17:07
 * @license http://www.shopnc.net
 * @link http://www.shopnc.net
 * @description 推广分佣基本信息
 */
public class DistributionInfo {
    ...
    public static class DatasBean {
         ...
         * distributorOrdersCount : 12
         */

        private DistributorJoinBean distributorJoin;
        private int distributorGoodsCount;
        private DistributorBean distributor;
        private int distributorOrdersCount;
        ...
        public int getDistributorGoodsCount() {
            return distributorGoodsCount;
        }

        public void setDistributorGoodsCount(int distributorGoodsCount) {
            this.distributorGoodsCount = distributorGoodsCount;
        }
        ...
        public int getDistributorOrdersCount() {
            return distributorOrdersCount;
        }

        public void setDistributorOrdersCount(int distributorOrdersCount) {
            this.distributorOrdersCount = distributorOrdersCount;
        }
