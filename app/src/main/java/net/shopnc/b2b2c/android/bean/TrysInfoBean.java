 ...
 * @Author qyf
 *
 * Created 2017/2/9 17:21.
 */

public class TrysInfoBean {
    private int trysId;
    ...
    private long trysStateFromTime;
    ...
    public long getTrysStateFromTime() {
        return trysStateFromTime;
    }

    public void setTrysStateFromTime(long trysStateFromTime) {
        this.trysStateFromTime = trysStateFromTime;
    }

    public long getEndTimeDownTime() {
        return endTimeDownTime;
    }
