 ...
 */
public class MyDiscountCoupon extends LinearLayout {
    ...
    public MyDiscountCoupon(Context context, AttributeSet attr) {
        super(context, attr);
...
//            canvas.drawCircle(0, h, radius, paint);
